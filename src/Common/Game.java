...
public class Game implements Serializable {
    ...
    public double stars; // Fix A2: double για ακρίβεια
    ...
    public Game(String name, String provider, int stars, int votes, String logo, double min, double max, String risk, String key) {
        this.gameName = name; this.providerName = provider; 
    ...
    public void addRating(int r) {
        ...
        this.noOfVotes++;
        this.stars = (double) totalStarsSum / noOfVotes; // Ακριβής μέσος όρος
    }
