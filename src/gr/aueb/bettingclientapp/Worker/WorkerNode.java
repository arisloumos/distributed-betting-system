package gr.aueb.bettingclientapp.Worker;

import java.io.*;
import java.net.*;
import java.util.*;

import gr.aueb.bettingclientapp.Common.*;
...
public class WorkerNode {
    ...
    private static double processBetNumeric(String playerId, String gameName, double betAmount) {
        ...
        System.out.println("[DEBUG] Worker attempting to connect to SRG at: " + SRG_IP + ":" + SRG_PORT);
