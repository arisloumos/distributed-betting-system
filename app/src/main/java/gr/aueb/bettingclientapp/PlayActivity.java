...
public class PlayActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
       ...
       //Ζητάμε από το Android να ψάξει αν υπάρχει αρχείο με αυτό το όνομα στον φάκελο drawable
            ...
            if (fromUser) {
                ...
                NetworkManager.sendRateRequest(game.gameName, (int) rating, new NetworkManager.NetworkCallback<String>() {
                    ...
                    public void onSuccess(String res) {
                        ...
                        //Κλείνουμε την οθόνη και γυρνάμε στο Search
                        finish();
                    }
        ...
        btnSkip.setOnClickListener(v -> {
            // Κανει σκιπ την τρέχουσα οθόνη και σε γυρνάει στην προηγούμενη
            finish();
        });
    }

    // Ζητάει το υπόλοιπο από τον Master και ενημερώνει την οθόνη
